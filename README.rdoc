...
Once you cloned this project to your disk, you can use SSH auth to make it so that you don't have to reenter
your credentials every time. For that to work, run:
  git config --edit
