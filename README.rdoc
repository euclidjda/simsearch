...
SimSearch is a Ruby on Rails application. {Rails related information is below}[https://github.com/euclidjda/simsearch#rails].

== Development Environment
This tutorial assumes you are running on Mac OSX. 

1.If you are running on Mountain Lion, you need to re-enable the web sharing. 
...
2. You need to install Ruby and Rails. You can use this tutorial to get you going with Ruby, Rails and RVM. 
The sample used sqlite3 which is already installed on your machine. It should work before you continue.
  http://pragmaticstudio.com/blog/2010/9/23/install-rails-ruby-mac/

3. Install MySQL and MySQL Workbench from here.
